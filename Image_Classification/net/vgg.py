...
def vgg11(spectral_normalization=True, mod=True, temp=1.0, mnist=False, imagenet=False, **kwargs):
    model = VGG("VGG11", spectral_normalization=spectral_normalization, mod=mod, temp=temp, mnist=mnist, imagenet=imagenet, **kwargs)
    return model


def vgg13(spectral_normalization=True, mod=True, temp=1.0, mnist=False, imagenet=False, **kwargs):
    model = VGG("VGG13", spectral_normalization=spectral_normalization, mod=mod, temp=temp, mnist=mnist, imagenet=imagenet, **kwargs)
    return model


def vgg16(spectral_normalization=True, mod=True, temp=1.0, mnist=False, imagenet=False, **kwargs):
    model = VGG("VGG16", spectral_normalization=spectral_normalization, mod=mod, temp=temp, mnist=mnist, imagenet=imagenet, **kwargs)
    return model


def vgg19(spectral_normalization=True, mod=True, temp=1.0, mnist=False, imagenet=False, **kwargs):
